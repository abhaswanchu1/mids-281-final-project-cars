...
pca_features = np.load(r"C:\Users\mhurth\REPO\MIDS281\mids-281-final-project-cars\XWithResNetFeatures2000PCA.npy")
pca_features_val = np.load(r"C:\Users\mhurth\REPO\MIDS281\mids-281-final-project-cars\X_valWithResNetFeatures2000PCA.npy")
...
# # Save to CSV
# results_df.to_csv(r"C:\Users\mhurth\REPO\MIDS281\mids-281-final-project-cars\PCA_Component_Sensitivity.csv",
#                   index=False)
